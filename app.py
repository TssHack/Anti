...
💪 **قابلیت‌های ویژه:**
• دانلود فایل‌های تا 5GB از لینک مستقیم
• دانلود فایل‌های تا 20MB از تلگرام
• نوار پیشرفت دقیق
• ادامه دانلود در صورت قطعی

⚠️ **محدودیت‌های تلگرام:**
• Bot API: حداکثر 20MB
• کاربران عادی: حداکثر 2GB
• پریمیوم: حداکثر 4GB
...
📤 **نحوه استفاده:**
• فایل کوچک: مستقیماً ارسال کنید
• فایل بزرگ: لینک مستقیم بفرستید
...
None_extension = Path(document.file_name).suffix.lower()
